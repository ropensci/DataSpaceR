...
#>   Available studies: 387
#>     - 78 studies with data
#>     - 5073 subjects
#>     - 439831 data points
#>   Available groups: 17
#>   Available publications: 1730
...
|:----------|:----------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-------------------------|:--------|:---------------|:------------------|:----------|:------------------------------------|:-------|:-----------------|:--------------------|
|cor01      |NA                           |The correlate of risk targeted intervention study (CORTIS):  A randomized, partially-blinded, clinical trial of isoniazid and rifapentine (3HP) therapy to prevent pulmonary tuberculosis in high-risk individuals identified by a transcriptomic correlate of risk |Phase III                 |Inactive |Assays complete |Human              |NA         |NA                                   |GHDC    |NA                |NA                   |
|cvd232     |Parks_RV_232                 |​Limiting Dose Vaginal SIVmac239 Challenge of RhCMV-SIV vaccinated Indian rhesus macaques.                                                                                                                                                                           |Pre-Clinical NHP          |Inactive |Assays complete |Rhesus macaque     |2009-11-24 |Vector vaccines (viral or bacterial) |CAVD    |NA                |NA                   |
|cvd234     |Zolla-Pazner_Mab_test1 Study |Zolla-Pazner_Mab_Test1                                                                                                                                                                                                                                              |Antibody Characterization |Inactive |Assays complete |Non-organism study |2009-02-03 |Prophylactic neutralizing Ab         |CAVD    |NA                |NA                   |
|cvd235     |mAbs potency                 |Weiss mAbs potency                                                                                                                                                                                                                                                  |Antibody Characterization |Inactive |Assays complete |Non-organism study |2008-08-21 |Prophylactic neutralizing Ab         |CAVD    |NA                |NA                   |
|cvd236     |neutralization assays        |neutralization assays                                                                                                                                                                                                                                               |Antibody Characterization |Active   |In progess      |Non-organism study |2009-02-03 |Prophylactic neutralizing Ab         |CAVD    |NA                |NA                   |
|cvd238     |Gallo_PA_238                 |HIV-1 neutralization responses in chronically infected individuals                                                                                                                                                                                                  |Antibody Characterization |Inactive |Assays complete |Non-organism study |2009-01-08 |Prophylactic neutralizing Ab         |CAVD    |NA                |NA                   |
...
#> <DataSpaceStudy>
#>   Study: cvd256
#>   URL: https://dataspace-staging.cavd.org/CAVD/cvd256
#>   Available datasets:
...
#> [1] 1419   33
colnames(NAb)
#>  [1] "participant_id"      "participant_visit"   "visit_day"           "assay_identifier"   
#>  [5] "summary_level"       "specimen_type"       "antigen"             "antigen_type"       
#>  [9] "virus"               "virus_type"          "virus_insert_name"   "clade"              
#> [13] "neutralization_tier" "tier_clade_virus"    "target_cell"         "initial_dilution"   
#> [17] "titer_ic50"          "titer_ic80"          "response_call"       "nab_lab_source_key" 
#> [21] "lab_code"            "exp_assayid"         "titer_id50"          "titer_id80"         
#> [25] "nab_response_id50"   "nab_response_id80"   "slope"               "vaccine_matched"    
#> [29] "study_prot"          "virus_full_name"     "virus_species"       "virus_host_cell"    
#> [33] "virus_backbone"
```
...
#> <DataSpaceStudy>
#>   Study: CAVD
#>   URL: https://dataspace-staging.cavd.org/CAVD
#>   Available datasets:
#>     - Binding Ab multiplex assay
#>     - Demographics
...
|name         |label                           |      n|integrated |
|:------------|:-------------------------------|------:|:----------|
|BAMA         |Binding Ab multiplex assay      | 176019|TRUE       |
|Demographics |Demographics                    |   5073|TRUE       |
|ELISPOT      |Enzyme-Linked ImmunoSpot        |   5610|TRUE       |
|ICS          |Intracellular Cytokine Staining | 205620|TRUE       |
|NAb          |Neutralizing antibody           |  52582|TRUE       |
...
|      226|HVTN 505 case control polyfunctionality and BAMA |HVTN 505 case control polyfunctionality and BAMA |Compares ICS polyfunctionality (CD8+, Any Env) to BAMA mfi-Delta (single Env antigen) in case control cohort |drienna    |TRUE   | 170|vtn505                                 |
|      227|HVTN 505 case control                            |HVTN 505 case control                            |HVTN 505 subjects in analysis of case control cohort                                                         |drienna    |TRUE   | 189|vtn505                                 |
|      229|human ics                                        |human ics                                        |human studies with ICS data                                                                                  |jmtaylor   |FALSE  | 499|vtn097, vtn505, vtn105, cvd579, cvd264 |
|      241|CAVD 650                                         |CAVD 650                                         |No description given.                                                                                        |binalp     |TRUE   |  20|cvd650                                 |
|      243|test cvd345 group                                |test cvd345 group                                |Testing group feature                                                                                        |drienna    |TRUE   | 101|cvd345                                 |
|      255|test CAVD 264 not shared then shared             |test CAVD 264 not shared then shared             |test what happens when you change share status on groups                                                     |drienna    |TRUE   |  45|cvd264                                 |
|      258|test CAVD 316 shared then not shared with edits  |test CAVD 316 shared then not shared with edits  |what happens when you edit a shared group and change to not shared                                           |drienna    |TRUE   |  18|cvd316                                 |
|      261|test CAVD 323 shared then not shared with edits  |test CAVD 323 shared then not shared with edits  |try to repro in Firefox                                                                                      |drienna    |TRUE   |  34|cvd323                                 |
|      264|test CAVD 392 shared then not                    |test CAVD 392 shared then not                    |test                                                                                                         |drienna    |TRUE   |  41|cvd392                                 |
|      266|Jason 239                                        |Jason 239                                        |No description given.                                                                                        |jmtaylor   |FALSE  |  38|cvd239                                 |
|      267|Jason 240                                        |Jason 240                                        |test                                                                                                         |jmtaylor   |FALSE  |  22|cvd239                                 |
|      269|Jason 242                                        |Jason 242                                        |test                                                                                                         |jmtaylor   |FALSE  |   7|cvd242                                 |
|      271|Jason 256                                        |Jason 256                                        |NA                                                                                                           |jmtaylor   |FALSE  | 121|cvd256                                 |
|      272|test CAVD 380                                    |test CAVD 380                                    |test                                                                                                         |drienna    |TRUE   |  18|cvd380                                 |
|      277|test CAVD 411 shared not shared                  |test CAVD 411 shared not shared                  |test                                                                                                         |drienna    |TRUE   |  24|cvd411                                 |
|      279|test CAVD 371                                    |test CAVD 371                                    |test                                                                                                         |drienna    |TRUE   |  52|cvd371                                 |
