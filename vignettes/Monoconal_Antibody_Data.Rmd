...
|10E8 V4.0      |human         |IgG3    |Env           |        28|        3|       1|                 0.0024094|         1|
|10E8 V4.0/iMab |human         |IgG3    |Env           |       119|       12|       6|                 0.0015396|         1|
...
#> [1] "Q23.17"  "6535.3"  "BaL.26"  "242-14"  "DJ263.8"
...
```r
names(mab)
#>  [1] ".__enclos_env__"     "variableDefinitions" "assays"              "studies"            
#>  [5] "nabMab"              "mabMetadata"         "mabStudyLabels"      "config"             
#>  [9] "clone"               "refresh"             "print"               "initialize"
```

DataSpaceR can also fetch and add metadata associated with downloaded mAbs via the `loadLanlMetadata` method that is associated with the `DataSpaceMab` object.


```r
mab$loadLanlMetadata()
...
#> Error in eval(expr, envir, enclos): object 'mab_name_std' not found
```
