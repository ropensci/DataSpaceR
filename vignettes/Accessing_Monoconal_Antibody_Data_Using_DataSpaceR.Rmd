...
You can retrive values from the grid by `mab_mixture`, `donor_species`, `isotype`, `hxb2_location`, `tiers`, `clades`, `viruses`, and `studies`, or you can access values in the `mabGridBase` field in the connection object
