...
We'll be looking at study `cvd408`. If you want to use a different study, change that string. The connections have state, so you can instantiate multiple connections to different studies simultaneously.

```{r CreateConnection}
library(DataSpaceR)
cvd256 <- CreateConnection(study = "cvd256")
cvd256
