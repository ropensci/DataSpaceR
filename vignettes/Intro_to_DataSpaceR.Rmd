...
`con$availableStudies` shows the available studies in the CAVD DataSpace. Check out [the reference page](https://cavddataspace.github.io/DataSpaceR/reference/DataSpaceConnection.html) of `DataSpaceConnection` for all available fields and methods.
...
Check out [the reference page](https://cavddataspace.github.io/DataSpaceR/reference/DataSpaceStudy.html) of `DataSpaceStudy` for all available fields and methods.
...
| `treatmentArm` | The table of treatment arm information for the connectedstudy. Not available for all study connection. |
