...
Since `FredHutch/DataSpaceR` is a private repository, a personal access token 
from Github (`GITHUB_PAT`) is required. A new token can be generated [here](https://github.com/settings/tokens), and select `repo` scope for the token.
