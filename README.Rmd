...
For more detailed examples and detailed documentation, see [the introductory vignette](https://docs.ropensci.org/DataSpaceR/articles/Intro_to_DataSpaceR.html) and [the pkgdown site](https://docs.ropensci.org/DataSpaceR/).
