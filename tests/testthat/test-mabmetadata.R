  ...
  test_that(
    "All loadAlignement objects have the correct column names",
    {
      colList <- list(
        ...
        "topMatches"      = c("mab_id","mab_name_std","mab_lanlid","mab_hxb2_location","mab_ab_binding_type","mab_isotype","mab_donorid","mab_donor_species","mab_donor_clade","allele","sequence_id","percent_identity","matches","alignment_length","score","preferred_status","run_application"),
