  ...
  public = list(
    ...
    loadAvailableDatasets = function(availableDatasets = self$availableDatasets, downloadDir = tempdir()) {
      ...
      if("BCR_Sequence" %in% assays){
        ...
        message("Querying BCR sequence study data, this may take a few minutes...")
        ...
        bcr_sequence <-
          Map(
            ...
            labkey.selectRows(
              ...
              colFilter=makeFilter(c("prot", "IN", studyId)),
              colNameOpt="rname"
            ) |> setDT(),
            private$.studyIds
          ) |> rbindlist()
